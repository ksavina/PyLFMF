...
// Warnings
#define TX_CORRECTED      	    2000
#define RX_CORRECTED		    2001
#define TX_RX_CORRECTED		    2002
...
Result LFMF(double h_tx__meter, double h_rx__meter, double f__mhz, double P_tx__watt,
...
int ValidateInput(double &h_tx__meter, double &h_rx__meter, double f__mhz, double P_tx__watt,
    double N_s, double d__km, double epsilon, double sigma, double lambda__meter, int pol);
